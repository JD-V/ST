  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div id="MemberRegistrationForm">
          <form class="form-horizontal"  role="form" name="MemRegForm" id="MemRegForm" action="MemberReg.php?_auth=<?php echo $_SESSION['AUTH_KEY']; ?>" method="post">
              ...
              <div class="form-group">
                <label for="MemberID" class="control-label col-sm-3 lables">ID Number<span class="mandatoryLabel">*</span></label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="MemberID" maxlength="11" name="MemberID" placeholder="Enter a ID"  value="<?php  if(isset($subEventData['EventCode'])) echo  $subEventData['TimeFrame']; ?>" >
                </div>
                <div id="errorMsgMID" name="errorMsgMID"  class="errorMessage" role="error"></div>
              </div>

              <div class="form-group">
                <label for="MemberEmail" class="control-label col-sm-3 lables">Email<span class="mandatoryLabel">*</span></label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
              <label for="MemCity" class="control-label col-sm-3 lables">City<span class="mandatoryLabel">*</span></label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label for="MemAddress" class="control-label col-sm-3 lables">Address<span class="mandatoryLabel">*</span></label>
               <div class="col-sm-4">
            ...
            <div class="form-group">
              <label for="MemProf" class="control-label col-sm-3 lables">Profession<span class="mandatoryLabel">*</span></label>
              <div class="col-sm-4">
              ...
              <div id="errorMsgMPR" name="errorMsgMPR" class="errorMessage" role="error"></div>
            </div>

            <div class="form-group">
              <label for="MemRef" class="control-label col-sm-3 lables">Reference<span class="mandatoryLabel">*</span></label>
              <div class="col-sm-4">
              ...
              <div id="errorMsgREF" name="errorMsgBDY" class="errorMessage" role="error"></div>
            </div>
