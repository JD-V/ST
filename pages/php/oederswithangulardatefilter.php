    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <span class=" total-count" > {{ordersNgParamss.total()}}</span> Record(s) matching
        </div>
      </div>
      <div class="box-body">
      <div class="table-responsive col-sm-12" >
        <table class="table table-striped table-hover" ng-table="ordersNgParamss" show-filter="true" >
          <tr ng-repeat='order in $data'>
            ...
            <td align="center" title="'Paid'" sortable="'amountPaid'" filter="{amountPaid: 'text'}" >{{order.amountPaid | number:2}}</td>
